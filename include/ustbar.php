...
">
      <div>
        <img width="50px" style="border-radius:50%;" src="https://www.tuyid.org/files/zirve2019/BasakKural.png" alt="img">
      </div>
      <div style="
    display: flex;
...
">Pro</div>
    ...
    gap: 6px;
">
       <a href="muaf_ogrenciler.php">    <span class="material-symbols-outlined"> signal_cellular_alt </span> Muaf Başvurusu Onaylanmış Öğrenciler </a>
      </div>
      <div style="
    display: flex;
    align-items: center;
    gap: 6px;
">
      <a href="muafiyet_kontrol.php">   <span class="material-symbols-outlined"> border_color </span> Muafiyet Kontrol
      </a></div>
      <hr style="width:100%;">
    ...
    gap: 10px;
">
        <span class="material-symbols-outlined">  </span> muafiyet_kontrol_yeni.php
      </div>
  ...
  -->
    ...
    gap: 6px;
">
       <a href="muafiyet_kontrol_yeni.php">    <span class="material-symbols-outlined"> signal_cellular_alt </span> Muafiyet Kontrol <strong style="color: red;">Yeni!</strong></a>
      </div>
